...
const GameCard = ({
  ...
  const isStale = game.state.status === 'IN_PROGRESS' && 
  ...
  return (
    <div className='game-item'>
      <p>
        <strong>Game Type:</strong> {game.gameType} | <strong>Game ID:</strong> {game.gameID} | <strong>Status:</strong> {game.state.status}
      </p>
